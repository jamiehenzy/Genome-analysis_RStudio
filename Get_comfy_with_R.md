...
This lesson is adapted from a version adapted by Selena Caplins from the STEMinist_R lessons produced by several UC Davis graduate students, found [here](https://github.com/ecalfee/STEMinist_R.git). 
